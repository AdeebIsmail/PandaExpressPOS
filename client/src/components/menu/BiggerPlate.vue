<!--
  Plate.vue
  This Vue component handles logic for displaying and selecting items from the Panda Express bigger plate menu


  Key Features:
  - display available sides and entrees
  - ensure user selects one side and three entrees
